...
def woods():
    ...
    while wood1 == "SHED":
        ...
        time.sleep(2)
        print(
            "John runs through the woods for an hour or so, stopping to catch his breath he hears a howl in the distance...")
        time.sleep(2)
        print(
            "Coming into a clearing, John spots a series of three graves. Each of these graves seems to have been recently disturbed.")
        time.sleep(2)
        ...
        if grave == "1":
            ...
            time.sleep(2)
            print(
                "John looks around, and decides to dig up the third grave. In this grave John finds a Medkit, and uses it to patch himself up.")
            time.sleep(2)
            play_hp = 140
        print("After digging up a grave, John continues to walk, deeper into the woods.")
        time.sleep(2)
        print(
            "John walking through the dark eeire wood hears a strange sound... A human-like growling, followed by a howl.")
        time.sleep(2)
        print("Stepping into a clearing, John comes face to face with an old grizzled man...")
        time.sleep(2)
        print(
            "The man upon seeing John, screams, and hunches. As hair beins sprouting from his back, and he grows sharp lethal claws...")
        time.sleep(3)
            ...
            while mpastdoor == "LDOOR":
                ...
                while note_chek == "YES":
                    ...
                    while tapestries == "ART":
                        time.sleep(2)
                        checked = input(
                            "Each of the scenes depicted on the tapestries, are of nature. Which do you examine? (Sheep/Mountains/River/Back): ")
                        ...
                        while checked == "SHEEP":
                            ...
                            time.sleep(2)
                            print(
                                "Towards the bottom of the art piece, a 6 with a sub-notation of 1 is stitched to the corner.")
                            checked = ""
                        while checked == "MOUNTAINS":
                            ...
                            time.sleep(2)
                            print(
                                "Towards the bottom of the art piece, a 3 with a sub-notation of 2 is stitched to the corner.")
                            checked == ""
                        while checked == "RIVER":
                            time.sleep(2)
            ...
            while mpastdoor == "STAIRS":
                ...
                if quesstdoor == "YES":
                    ...
                    if css1 == 3 and css2 == 5 and css3 == 8 and css4 == 6:
                        print(
                            "The door swings open, revealing a large board room. At the far end, sits a man in a tailored suit.")
                        time.sleep(2)
                        print(
                            "The Boss: Well Well Well... Look who finally made it... You thought you could kill my boys...")
                        time.sleep(3)
...
if c2 == "ESCAPE":
    ...
    if c4 == ("dig"):
        ...
        time.sleep(2)
        c5 = input(
            "John, now facing a dilemma may venture into the mansion to seek vengeance or flee to the woods...(Woods/House)")
        c5 == c5.upper()
        if c5 == "WOODS":
            time.sleep(2)
